	...
	public class Main extends Sprite 
	{
		...
		public function Main():void 
		{
			...
			//Загружаем XML  	
						...
						c.graphics.lineStyle(0.5, 0xFFFFFF);
						c.graphics.moveTo(cubeX-64.5, cubeY-31);
						c.graphics.lineTo( -570, cubeY-31);
						c.scaleX = 0;
						globalContainer.addChild(c);
						
						var c1:Sprite = new Sprite();
						//c1.graphics.beginFill(0xFFFFFF, 0.3);
						c1.graphics.lineStyle(0.5, 0xFFFFFF);
						c1.graphics.drawRect(127, 69, 500, 646);
						addChild(c1);
						...
						function yUpFinish(event:Event):void
						{
							...
							tm.append(TweenLite.to(c, 1, { scaleX:1} ));
							//tm.append(TweenLite.to(c1, 1, {scrollRect:{bottom:200}}));
							tm.append( TweenLite.to(TextAboutContainer, 2, { scaleY:1 } ));
							tm.append( TweenLite.to(TextAbout, 3, { alpha:1 } ));
							addEventListenerMenuButton();	
			...
			withDesignerContainer.x = 100;
			withCompanyContainer.x = 100;
			 ...
			 *  класс о компании  
			 */
			var aboutTxt:HtmlTxtLoader= new HtmlTxtLoader(CubeConfig.TOOLTIPTEXT6.text,CubeConfig.FillButton6,stage,TextAbout, TextAboutContainer, urlAbout); 
				
				TextAboutContainer.scaleY = 0;
				TextAbout.alpha = 0;
		...
		public function DesignerDraw(container:MovieClip):void
		{
			...
			//var pentX:Array = [xn[0]-60,xn[0]-10,xn[10]-10,xn[10]-60,xn[0]-90,xn[20]-10,xn[20]-60,xn[20]-90,xn[30]-10,xn[30]-60,xn[30]-90,xn[40]-10,xn[40]-60,xn[40]-90];
			//var pentY:Array = [65,yn[0],yn[10],143,103,yn[20],216,181,yn[30],292,258,yn[40],370,334];
			...
			//
			function pentagon1onClick(event:Event):void 
			{
				globalContainer.x = 300;
			}
			//==============================================================================
			...
			function prevbutton2OnClick():void
			{
			  ...
			  distortBmp2[0].texture = designer2.dThumbImage[0 + countD2];
			  distortBmp2[1].texture = designer2.dThumbImage[1 + countD2];
			  distortBmp2[2].texture = designer2.dThumbImage[2 + countD2];
			  distortBmp2[3].texture = designer2.dThumbImage[3 + countD2];
			  distortBmp2[4].texture = designer2.dThumbImage[4 + countD2];
			  distortBmp2[5].texture = designer2.dThumbImage[5 + countD2];
			  distortBmp2[6].texture = designer2.dThumbImage[6 + countD2];
			  distortBmp2[7].texture = designer2.dThumbImage[7 + countD2];
			  distortBmp2[8].texture = designer2.dThumbImage[8 + countD2]; 
			...
			function prevbutton3OnClick():void
			{
			  ...
			  distortBmp3[0].texture = designer3.dThumbImage[0 + countD3];
			  distortBmp3[1].texture = designer3.dThumbImage[1 + countD3];
			  distortBmp3[2].texture = designer3.dThumbImage[2 + countD3];
			  distortBmp3[3].texture = designer3.dThumbImage[3 + countD3];
			  distortBmp3[4].texture = designer3.dThumbImage[4 + countD3];
			  distortBmp3[5].texture = designer3.dThumbImage[5 + countD3];
			  distortBmp3[6].texture = designer3.dThumbImage[6 + countD3];
			...
			function prevbutton4OnClick():void
			{
			  ...
			  distortBmp4[0].texture = designer4.dThumbImage[0 + countD4];
			  distortBmp4[1].texture = designer4.dThumbImage[1 + countD4];
			  distortBmp4[2].texture = designer4.dThumbImage[2 + countD4];
			  distortBmp4[3].texture = designer4.dThumbImage[3 + countD4];
			  distortBmp4[4].texture = designer4.dThumbImage[4 + countD4];
			  distortBmp4[5].texture = designer4.dThumbImage[5 + countD4];
			  distortBmp4[6].texture = designer4.dThumbImage[6 + countD4];
			  distortBmp4[7].texture = designer4.dThumbImage[7 + countD4];
				...
				function mouseOverHandler(e:MouseEvent):void 
				{
					...
					function mouseClickHandler(e:MouseEvent):void 
					{
						...
						function Redriwing():void
						{
							...
							drawDistortBmp();
							createBtns();
							 pentX = [xn[0]-60,xn[0]-10,xn[10]-10,xn[10]-60,xn[0]-90,xn[20]-10,xn[20]-60,xn[20]-90,xn[30]-10,xn[30]-60,xn[30]-90,xn[40]-10,xn[40]-60,xn[40]-90];
...
//=======================================================================================================================================================================================================================================================				
			...
			public function WithDesigner(container:MovieClip):void
		{
			...
			var color_cube:Array = []; //
			var feel_color:uint = 0x000000; //цвет заливки
			var outMouse_color:uint = 0xCCD5FF; // цвет при наведении
			var onClick_color:uint = 0xFF0000; // цвет при нажатии
			var lineStyle:Number = 1; //толщина линии
			var lineColor:uint=0xFFFFFF; //цвет линии
			...
			function createBtns():void
			{
				createPicButton(prevbutton1, nextbutton1, 0, 9);	
				createPicButton(prevbutton2, nextbutton2, 10, 18);	
			...
			function prevbutton1OnClick():void
			{
			  ...
			  distortBmp1[0].texture = teamwork1.dThumbImage[0 + countD1];
			  distortBmp1[1].texture = teamwork1.dThumbImage[1 + countD1];
			  distortBmp1[2].texture = teamwork1.dThumbImage[2 + countD1];
			  distortBmp1[3].texture = teamwork1.dThumbImage[3 + countD1];
			  distortBmp1[4].texture = teamwork1.dThumbImage[4 + countD1];
			  distortBmp1[5].texture = teamwork1.dThumbImage[5 + countD1];
			  distortBmp1[6].texture = teamwork1.dThumbImage[6 + countD1];
			  distortBmp1[7].texture = teamwork1.dThumbImage[7 + countD1];
			  distortBmp1[8].texture = teamwork1.dThumbImage[8 + countD1]; 
			...
			function prevbutton2OnClick():void
			{
			  ...
			  distortBmp2[0].texture = teamwork2.dThumbImage[0 + countD2];
			  distortBmp2[1].texture = teamwork2.dThumbImage[1 + countD2];
			  distortBmp2[2].texture = teamwork2.dThumbImage[2 + countD2];
			  distortBmp2[3].texture = teamwork2.dThumbImage[3 + countD2];
			  distortBmp2[4].texture = teamwork2.dThumbImage[4 + countD2];
			  distortBmp2[5].texture = teamwork2.dThumbImage[5 + countD2];
			  distortBmp2[6].texture = teamwork2.dThumbImage[6 + countD2];
			  distortBmp2[7].texture = teamwork2.dThumbImage[7 + countD2];
				...
				function mouseOverHandler(e:MouseEvent):void 
				{
					...
					function mouseClickHandler(e:MouseEvent):void 
					{
						...
						if (button==mySprite[0])
						{
							...
							BmpLoader.loadadres(teamwork1.dFullImage[0+countD1]); 
						} 
						else if (button == mySprite[1]) 
						{
							
							BmpLoader.loadadres(teamwork1.dFullImage[1+countD1]); 
						} 
						else if (button == mySprite[2]) 
						{
							
							BmpLoader.loadadres(teamwork1.dFullImage[2+countD1]); 
						} 
						else if (button == mySprite[3]) 
						{
							
							BmpLoader.loadadres(teamwork1.dFullImage[3+countD1]); 
						} 
						else if (button == mySprite[4]) 
						{
							
							BmpLoader.loadadres(teamwork1.dFullImage[4+countD1]); 
						} 
						else if (button == mySprite[5]) 
						{
							
							BmpLoader.loadadres(teamwork1.dFullImage[5+countD1]); 
						} 
						else if (button == mySprite[6]) 
						{
							
							BmpLoader.loadadres(teamwork1.dFullImage[6+countD1]); 
						}
						else if (button == mySprite[7]) 
						{
							
							BmpLoader.loadadres(teamwork1.dFullImage[7+countD1]); 
						} 
						else if (button == mySprite[8]) 
						{
							
							BmpLoader.loadadres(teamwork1.dFullImage[8+countD1]); 
						} 
						else if (button == mySprite[9]) 
						{
							
							BmpLoader.loadadres(teamwork2.dFullImage[0+countD2]); 
						} 
						else if (button == mySprite[10]) 
						{
							
							BmpLoader.loadadres(teamwork2.dFullImage[1+countD2]); 
						}
						else if (button == mySprite[11]) 
						{
							
							BmpLoader.loadadres(teamwork2.dFullImage[2+countD2]); 
						}
						else if (button == mySprite[12]) 
						{
							
							BmpLoader.loadadres(teamwork2.dFullImage[3+countD2]); 
						}
						else if (button == mySprite[13]) 
						{
							
							BmpLoader.loadadres(teamwork2.dFullImage[4+countD2]); 
						}
						else if (button == mySprite[14]) 
						{
							
							BmpLoader.loadadres(teamwork2.dFullImage[5+countD2]); 
						}
						else if (button == mySprite[15]) 
						{
							
							BmpLoader.loadadres(teamwork2.dFullImage[6+countD2]); 
						}
						else if (button == mySprite[16]) 
						{
							
							BmpLoader.loadadres(teamwork2.dFullImage[7+countD2]); 
						}
						else if (button == mySprite[17]) 
						{
							
							BmpLoader.loadadres(teamwork2.dFullImage[8+countD2]); 
						}
     	...
     	public function WithCompany(container:MovieClip):void
		{
			...
			function createBtns():void
			{
				createPicButton(prevbutton1, nextbutton1, 0, 7);	
				createPicButton(prevbutton2, nextbutton2, 10, 18);	
			...
			function prevbutton1OnClick():void
			{
			  ...
			  distortBmp1[0].texture = cooperation1.dThumbImage[0 + countD1];
			  distortBmp1[1].texture = cooperation1.dThumbImage[1 + countD1];
			  distortBmp1[2].texture = cooperation1.dThumbImage[2 + countD1];
			  distortBmp1[3].texture = cooperation1.dThumbImage[3 + countD1];
			  distortBmp1[4].texture = cooperation1.dThumbImage[4 + countD1];
			  distortBmp1[5].texture = cooperation1.dThumbImage[5 + countD1];
			  distortBmp1[6].texture = cooperation1.dThumbImage[6 + countD1];
			...
			function prevbutton2OnClick():void
			{
			  ...
			  distortBmp2[0].texture = cooperation2.dThumbImage[0 + countD2];
			  distortBmp2[1].texture = cooperation2.dThumbImage[1 + countD2];
			  distortBmp2[2].texture = cooperation2.dThumbImage[2 + countD2];
			  distortBmp2[3].texture = cooperation2.dThumbImage[3 + countD2];
			  distortBmp2[4].texture = cooperation2.dThumbImage[4 + countD2];
			  distortBmp2[5].texture = cooperation2.dThumbImage[5 + countD2];
			  distortBmp2[6].texture = cooperation2.dThumbImage[6 + countD2];
			  distortBmp2[7].texture = cooperation2.dThumbImage[7 + countD2];
				...
				function mouseOverHandler(e:MouseEvent):void 
				{
					...
					function mouseClickHandler(e:MouseEvent):void 
					{
						...
						if (button==mySprite[0])
						{
							...
							BmpLoader.loadadres(cooperation1.dFullImage[0+countD1]); 
						} 
						else if (button == mySprite[1]) 
						{
							
							BmpLoader.loadadres(cooperation1.dFullImage[1+countD1]); 
						} 
						else if (button == mySprite[2]) 
						{
							
							BmpLoader.loadadres(cooperation1.dFullImage[2+countD1]); 
						} 
						else if (button == mySprite[3]) 
						{
							
							BmpLoader.loadadres(cooperation1.dFullImage[3+countD1]); 
						} 
						else if (button == mySprite[4]) 
						{
							
							BmpLoader.loadadres(cooperation1.dFullImage[4+countD1]); 
						} 
						else if (button == mySprite[5]) 
						{
							
							BmpLoader.loadadres(cooperation1.dFullImage[5+countD1]); 
						} 
						else if (button == mySprite[6]) 
						{
							
							BmpLoader.loadadres(cooperation1.dFullImage[6+countD1]); 
						}
						else if (button == mySprite[7]) 
						{
							
							BmpLoader.loadadres(cooperation1.dFullImage[7+countD1]); 
						} 
						else if (button == mySprite[8]) 
						{
							
							BmpLoader.loadadres(cooperation1.dFullImage[8+countD1]); 
						} 
						else if (button == mySprite[9]) 
						{
							
							BmpLoader.loadadres(cooperation2.dFullImage[0+countD2]); 
						} 
						else if (button == mySprite[10]) 
						{
							
							BmpLoader.loadadres(cooperation2.dFullImage[1+countD2]); 
						}
						else if (button == mySprite[11]) 
						{
							
							BmpLoader.loadadres(cooperation2.dFullImage[2+countD2]); 
						}
						else if (button == mySprite[12]) 
						{
							
							BmpLoader.loadadres(cooperation2.dFullImage[3+countD2]); 
						}
						else if (button == mySprite[13]) 
						{
							
							BmpLoader.loadadres(cooperation2.dFullImage[4+countD2]); 
						}
						else if (button == mySprite[14]) 
						{
							
							BmpLoader.loadadres(cooperation2.dFullImage[5+countD2]); 
						}
						else if (button == mySprite[15]) 
						{
							
							BmpLoader.loadadres(cooperation2.dFullImage[6+countD2]); 
						}
						else if (button == mySprite[16]) 
						{
							
							BmpLoader.loadadres(cooperation2.dFullImage[7+countD2]); 
						}
						else if (button == mySprite[17]) 
						{
							
							BmpLoader.loadadres(cooperation2.dFullImage[8+countD2]); 
						}
