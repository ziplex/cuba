...
import RootClass;
	...
	public class Main extends Sprite 
	{
		...
		public function Main():void 
		{
			...
			//======конец описания переменных
						   ...
						   DrawCubeMenu(cubicContainer,cubic, pCube[0], pCube[1], pCube[2], pCube[3], pCube[4], pCube[5],
																 ...
																 ):void
							{
								...
								menu_color1.graphics.beginFill(0x50AFDC,1);
								//btn1.graphics.lineStyle(0.5,colorline);
								...
								menu_color2.graphics.beginFill(0xA591AF,1);
								//btn2.graphics.lineStyle(0.5,colorline);
								...
								menu_color3.graphics.beginFill(0xDCAAB4,1);
								//btn3.graphics.lineStyle(0.5,colorline);
								...
								menu_color4.graphics.beginFill(0xEEEF8A,1);
								//btn4.graphics.lineStyle(0.5,colorline);
								...
								menu_color5.graphics.beginFill(0xF09B7D,1);
								//btn5.graphics.lineStyle(0.5,colorline);
								...
								menu_color6.graphics.beginFill(0xAED693,1);
								//btn6.graphics.lineStyle(0.5,colorline);
								...
								var colors5:Array = [0xFFFFFF, 0xFFFFFF];
								...
								var colors6:Array = [0xFFFFFF, 0xFFFFFF];
								...
								//рисуем линии граней
								obj.graphics.lineStyle(0.5,colorline,100,false,"none","none","miter",3);
								obj.graphics.moveTo(p_front.x,p_front.y);
     							obj.graphics.lineTo(p_inside2.x, p_inside2.y);
								obj.graphics.moveTo(p_front.x,p_front.y);
     							obj.graphics.lineTo(p_inside4.x, p_inside4.y);
								...
								obj.graphics.lineStyle(4,colorline,100,false,"normal","none","miter",3);
								...
								//тень
								ShadowCube.graphics.beginFill(0x000000,0.5);
							...
							function removeOn(event:Event):void
							{
								...
								EndTweenCub = true;// указываем что твины доиграли до конца
							}
			...
			var menuAlpha1:Boolean = false;
			var menuAlpha2:Boolean = false;
			var menuAlpha3:Boolean = false;
			var menuAlpha4:Boolean = false;
			var menuAlpha5:Boolean = false;
			var menuAlpha6:Boolean = false;
			...
			function menu6Click(event:MouseEvent):void
			{
				...
				if (!pressMenuButton6)
				{
					...
					cubicXTween.addEventListener(TweenEvent.MOTION_FINISH, xLeftFinish);
					removeEventListenerMenuButton();
				}
				
			}
			
			function xLeftFinish(event:Event):void
			{
					var cubicYTween:Tween = new Tween(cubicContainer, "y", Regular.easeInOut, cubeY, 100, 1, true)
			...
			function backCubic():void
			{
					...
					var cubicYTween:Tween = new Tween(cubicContainer, "y", Regular.easeInOut, 100, cubeY, 1, true)
					buttonTween.push(cubicYTween);
			...
			// фильтры свечения
			var DesignerGlow:GlowFilter = new GlowFilter(0x50AFDC, 1, 10, 10,5); 
			var WithCompanyGlow:GlowFilter = new GlowFilter(0xDCAAB4, 1, 10, 10,5); 
			var WithDesignersGlow:GlowFilter = new GlowFilter(0xF09B7D, 1, 10, 10,5); 
			...
			TextAboutContainer.x = 300;
			TextAboutContainer.y = 50;
			TextAboutContainer.visible = false;
