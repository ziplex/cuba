	...
	public class Main extends Sprite 
	{
		...
		public function Main():void 
		{
			...
			function DrawStartButton(colour:uint,alpha:uint):void
			{
				...
				startButton.graphics.drawRect(startX, startY, 100, 100);
...
//======================================================
			...
			function linears(obj:MovieClip,x1:Number,y1:Number,x2:Number,y2:Number,
				...
				//	_distortImage.setTransform(x1, y1, x2, y2, x4, y4,x3,y3);
					...
					//var dx41:Number = x4 - x1;
					//var dy41:Number = y4 - y1;
					//var dx32:Number = x3 - x2;
					//var dy32:Number = y3 - y2;
					//mtrx.translate(dx41, dy41);
					//trace(dy41)
					...
					obj.graphics.lineStyle(3,0xFFFFFF);
					obj.graphics.moveTo(x1,y1);
				...
				function changeCoord(a:int,b:int,c:int,d:int):void
				{
					...
					//===================================
					xn[a]=xm[a]-10;yn[a]=ym[a];
					xn[b]=xm[b]-10;yn[b]=ym[b];
					xn[c]=xm[c]-10;yn[c]=ym[c];
					xn[d]=xm[d]-10;yn[d]=ym[d];
					//===================================
					
					xn[a+2]+=shiftX[1]*0.5;yn[a+2]-=shiftY[1]*0.5;
					xn[b+2]-=shiftX[2]*0.5;yn[b+2]-=shiftY[2]*0.5;
					xn[c+2]+=shiftX[3]*0.5;yn[c+2]-=shiftY[3]*0.5;
					xn[d+2]-=shiftX[4]*0.5;yn[d+2]-=shiftY[4]*0.5;
					
					xn[a+3]+=shiftX[1]*0.25;yn[a+3]-=shiftY[1]*0.25;
					xn[b+3]-=shiftX[2]*0.25;yn[b+3]-=shiftY[2]*0.25;
					xn[c+3]+=shiftX[3]*0.25;yn[c+3]-=shiftY[3]*0.25;
					xn[d+3]-=shiftX[4]*0.25;yn[d+3]-=shiftY[4]*0.25;
					...
					{
						case 0:
								xn[a+2]=xm[a+2]-20;yn[a+2]=ym[a+2]-12;
								xn[b+2]=xm[b+2]-20;yn[b+2]=ym[b+2]-10;
								xn[c+2]=xm[c+2]+5;yn[c+2]=ym[c+2]-8;
								xn[d+2]=xm[d+2]+7;yn[d+2]=ym[d+2]-4;
								
						break;										
						
						case 1:	
								xn[a+2]=xm[a+2]-20;yn[a+2]=ym[a+2]-18;
								xn[b+2]=xm[b+2]-20;yn[b+2]=ym[b+2]-18;
								xn[c+2]=xm[c+2]-20;yn[c+2]=ym[c+2]-18;
								xn[d+2]=xm[d+2]-20;yn[d+2]=ym[d+2]-18;
