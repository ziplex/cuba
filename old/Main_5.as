...
import CubeXML;
	...
	public class Main extends Sprite 
	{
		...
		public function Main():void 
		{
			...
			var MainUrl:String;
			// фильтры свечения
			var DesignerGlow:GlowFilter// = new GlowFilter(PLATO1LIGHT, 0.3, 10, 10,5); 
			var WithCompanyGlow:GlowFilter// = new GlowFilter(PLATO2LIGHT, 0.3, 10, 10,5); 
			var WithDesignersGlow:GlowFilter// = new GlowFilter(PLATO3LIGHT, 0.3, 10, 10,5,2); 
			...
			var cbxm:CubeXML = new CubeXML();
			cbxm.loadMainXml("data/main.xml", ccc);
			
			function ccc():void
			{
			  trace("CUBEXML = ",cbxm.TOOLTIPTEXT6.text)
			}
			
			var Desi:Designers=new Designers();
			Desi.loadXML("data/designer2/designer2.xml",des);
			
			function des():void
			{
				trace("проверка = ",Desi.count);
			}
			...
			function loadMain():void
					{
						...
						//Загружаем XML  	
						   ...
						   {  
							   ...
							   var t1Width:Number = TOOLTIPTEXT1.textWidth+8;
							   var t1Height:Number = TOOLTIPTEXT1.textHeight+5;
							   TOOLTIPTEXT1.width = TOOLTIPTEXT1.textWidth+10;
							   TOOLTIPTEXT1.height = TOOLTIPTEXT1.textHeight+10;
							   
							   TolTip1.graphics.beginFill(TOOLTIPFILL1, TOOLTIPALPHA1);
							   TolTip1.graphics.lineStyle(TOOLTIPALPHALINE1, TOOLTIPCOLORLINE1);
							   ...
							   TolTip1.addChild(TOOLTIPTEXT1);
							   
							   var t2Width:Number = TOOLTIPTEXT2.textWidth+8;
							   var t2Height:Number = TOOLTIPTEXT2.textHeight+5;
							   TOOLTIPTEXT2.width = TOOLTIPTEXT2.width+10;
							   TOOLTIPTEXT2.height = TOOLTIPTEXT2.textHeight+10;
							   
							   TolTip2.graphics.beginFill(TOOLTIPFILL2, TOOLTIPALPHA2);
							   TolTip2.graphics.lineStyle(TOOLTIPALPHALINE2, TOOLTIPCOLORLINE2);
							   ...
							   TolTip2.addChild(TOOLTIPTEXT2);
							   
							   
							   var t3Width:Number = TOOLTIPTEXT3.textWidth+8;
							   var t3Height:Number = TOOLTIPTEXT3.textHeight+5;
							   TOOLTIPTEXT3.width = TOOLTIPTEXT3.width+30;
							   TOOLTIPTEXT3.height = TOOLTIPTEXT3.textHeight+10;
							   
							   TolTip3.graphics.beginFill(TOOLTIPFILL3, TOOLTIPALPHA3);
							   TolTip3.graphics.lineStyle(TOOLTIPALPHALINE3, TOOLTIPCOLORLINE3);
							   ...
							   TolTip3.addChild(TOOLTIPTEXT3);
							   
							   var t4Width:Number = TOOLTIPTEXT4.textWidth+8;
							   var t4Height:Number = TOOLTIPTEXT4.textHeight+5;
							   TOOLTIPTEXT4.width = TOOLTIPTEXT4.width+30;
							   TOOLTIPTEXT4.height = TOOLTIPTEXT4.textHeight+10;
							   
							   TolTip4.graphics.beginFill(TOOLTIPFILL4, TOOLTIPALPHA4);
							   TolTip4.graphics.lineStyle(TOOLTIPALPHALINE4, TOOLTIPCOLORLINE4);
							   ...
							   TolTip4.addChild(TOOLTIPTEXT4);
							   
							   var t5Width:Number = TOOLTIPTEXT5.textWidth+8;
							   var t5Height:Number = TOOLTIPTEXT5.textHeight+5;
							   TOOLTIPTEXT5.width = TOOLTIPTEXT5.width+10;
							   TOOLTIPTEXT5.height = TOOLTIPTEXT5.textHeight+10;
							   
							   TolTip5.graphics.beginFill(TOOLTIPFILL5, TOOLTIPALPHA5);
							   TolTip5.graphics.lineStyle(TOOLTIPALPHALINE5, TOOLTIPCOLORLINE5);
							   ...
							   TolTip5.addChild(TOOLTIPTEXT5);
							   
							   var t6Width:Number = TOOLTIPTEXT6.textWidth+8;
							   var t6Height:Number = TOOLTIPTEXT6.textHeight+5;
							   TOOLTIPTEXT6.width = TOOLTIPTEXT6.width+10;
							   TOOLTIPTEXT6.height = TOOLTIPTEXT6.textHeight+10;
							   
							   TolTip6.graphics.beginFill(TOOLTIPFILL6, TOOLTIPALPHA6);
							   TolTip6.graphics.lineStyle(TOOLTIPALPHALINE3, TOOLTIPCOLORLINE6);
						  ...
						  function CreateCube():void
						  {
						   DrawCubeMenu(cubicContainer,cubic, pCube[0], pCube[1], pCube[2], pCube[3], pCube[4], pCube[5],
																 ...
																 ):void
							{
								...
								menu_color1.graphics.beginFill(FillButton1,AlphaButton1);
								//btn1.graphics.lineStyle(0.5,colorline);
								...
								menu_color2.graphics.beginFill(FillButton2,AlphaButton2);
								//btn2.graphics.lineStyle(0.5,colorline);
								...
								menu_color3.graphics.beginFill(FillButton3,AlphaButton3);
								//btn3.graphics.lineStyle(0.5,colorline);
								...
								menu_color4.graphics.beginFill(FillButton4,AlphaButton4);
								//btn4.graphics.lineStyle(0.5,colorline);
								...
								menu_color5.graphics.beginFill(FillButton5,AlphaButton5);
								//btn5.graphics.lineStyle(0.5,colorline);
								...
								menu_color6.graphics.beginFill(FillButton6,AlphaButton6);
								//btn6.graphics.lineStyle(0.5,colorline);
								...
								var colors1:Array = [Gran1Fill1, Gran1Fill2];
								...
								var colors2:Array = [Gran2Fill1, Gran2Fill2];
								...
								var colors3:Array = [Gran3Fill1, Gran3Fill2];
								...
								var colors4:Array = [Gran4Fill1, Gran4Fill2];
								...
								var colors5:Array = [Gran5Fill1, Gran5Fill2];
								...
								var colors6:Array = [Gran6Fill1, Gran6Fill2];
								...
								//рисуем линии граней
								obj.graphics.lineStyle(GranThicknessLine,GranColorLine,GranAlphaLine,false,"none","none","miter",3);
								obj.graphics.moveTo(p_front.x,p_front.y);
     							obj.graphics.lineTo(p_inside2.x, p_inside2.y);
								obj.graphics.moveTo(p_front.x,p_front.y);
     							obj.graphics.lineTo(p_inside4.x, p_inside4.y);
								...
								obj.graphics.lineStyle(OutSideThicknessLine,OutSideColorLine,OutSideAlphaLine,false,"normal","none","miter",3);
								...
								obj.graphics.lineStyle(InSideThicknessLine,InSideColorLine,InSideAlphaLine,false,"normal","none","miter",3);
								...
								//тень
								ShadowCube.graphics.beginFill(ShadowCubeColor,ShadowCubeAlpha);
...
//======================================================
			...
			{   
				//Первый ряд
				linears(mySprite[0],xn[0],yn[0],xn[1],yn[1],xn[10],yn[10],xn[11],yn[11],Designer1ThuminalsBitmap[0],Mymatrix,color_cube[0],cubeAlpha[0],lineStyle,lineColor);
				linears(mySprite[1],xn[1],yn[1],xn[2],yn[2],xn[11],yn[11],xn[12],yn[12],Designer1ThuminalsBitmap[1],Mymatrix,color_cube[1],cubeAlpha[1],lineStyle,lineColor);
			 	linears(mySprite[2],xn[2],yn[2],xn[3],yn[3],xn[12],yn[12],xn[13],yn[13],Designer1ThuminalsBitmap[2],Mymatrix,color_cube[2],cubeAlpha[2],lineStyle,lineColor);
				linears(mySprite[3],xn[3],yn[3],xn[4],yn[4],xn[13],yn[13],xn[14],yn[14],Designer1ThuminalsBitmap[3],Mymatrix,color_cube[3],cubeAlpha[3],lineStyle,lineColor);
				linears(mySprite[4],xn[4],yn[4],xn[5],yn[5],xn[14],yn[14],xn[15],yn[15],Designer1ThuminalsBitmap[4],Mymatrix,color_cube[4],cubeAlpha[4],lineStyle,lineColor);
				linears(mySprite[5],xn[5],yn[5],xn[6],yn[6],xn[15],yn[15],xn[16],yn[16],Designer1ThuminalsBitmap[5],Mymatrix,color_cube[5],cubeAlpha[5],lineStyle,lineColor);
				linears(mySprite[6],xn[6],yn[6],xn[7],yn[7],xn[16],yn[16],xn[17],yn[17],Designer1ThuminalsBitmap[6],Mymatrix,color_cube[6],cubeAlpha[6],lineStyle,lineColor);
				linears(mySprite[7],xn[7],yn[7],xn[8],yn[8],xn[17],yn[17],xn[18],yn[18],Designer1ThuminalsBitmap[7],Mymatrix,color_cube[7],cubeAlpha[7],lineStyle,lineColor);
