package 
{
	...
	{
		[Embed(source = 'font/MyriadPro-Regular.otf', fontFamily = 'MyriadPro-Regular')]
		
		private var MyriadPro:Class;
		//[Embed(source = 'font/MyriadPro-Bold.otf', fontFamily = 'MyriadPro-Bold', fontWeight = "bold")]
		//[Embed(source='font/MyriadPro-Semibold.otf',fontFamily = 'MyriadPro-Semibold', fontWeight = "bold")]
		//private var MyriadBold:Class;
		...
		/**
		 * тень для области текста
		 */
		 
		
		/**
		 * @param	SHADOWTEXT -цвет тени контейнера
		 * @param	cColor -цвет контейнера
		 * @param	cAlpha -прозрачность контейнера
		 * @param	сGradient -цвет градиента
		 ...
		 */
		public function HtmlTxtLoader(SHADOWTEXT:uint,cColor:uint,cAlpha:Number,cGradient:uint,txt:String,txtColor:uint,color:uint,globalStage :Stage,_output:TextField, TxtContainer:Sprite, url:String):void
			{
				 ...
				 */
				var containerColor:uint = cColor;
				var containerAlpha:Number = cAlpha;
				var gradientColor:uint = cGradient;
				/**
				...
				HeaderFormat.font = "MyriadPro-Semibold";
				...
				txtMask.graphics.beginFill(containerColor, containerAlpha);
				txtMask.graphics.drawRect(0, 0, txtWidth, txtHeight);
				...
				function createGradients():void 
				{
					...
					shadow.graphics.beginFill(SHADOWTEXT, 0.25);
					shadow.graphics.drawRect(0, 0, 5, txtHeight);
					shadow.graphics.endFill();
					shadow.graphics.beginFill(SHADOWTEXT, 0.25);
					shadow.graphics.drawRect(5, 0, txtWidth-5, 5);
					shadow.graphics.endFill();
				...
				scrollcontainer..addEventListener(MouseEvent.MOUSE_WHEEL, scrollWheel);
				function scrollWheel():void 
				{
					_output.scrollV = Math.round(((scrollbar.y - bounds.y)/txtHeight)*_output.maxScrollV);
				}
				function wheelTXT(event:MouseEvent):void 
				{
					...
					//trace(relation);
					scrollbar.y += -event.delta *txtHeight/ _output.maxScrollV;
					//_output.scrollV = Math.round(((scrollbar.y - bounds.y)/txtHeight)*_output.maxScrollV);
